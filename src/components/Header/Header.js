...
class Header extends React.Component{
    ...
    onbuttonclick=()=>{
      ...
      .then(data=>{
        ...
        this.props.onSearchRouteChange(data);     
      })
    }
...
<div>
    ...
    <div className='header_middle_panel'>
        <div className='header_middle_search'>
            <input type='text' placeholder='Enter your search' onChange={this.inputChange}></input>
    ...
    <div className='header_bottom_panel_1'>
        <p onClick={()=>{this.props.onPageRouteChange('mainPage')}}>HOME</p>
        <p onClick={()=>{this.props.onPageRouteChange('aboutPage')}}>ABOUT US</p>
        <p onClick={()=>{this.props.onPageRouteChange('contactPage')}}>CONTACT US</p>
    </div>
    <div className='header_bottom_panel_2'>
        <p onClick={()=>{this.props.onPageRouteChange('cartPage')}}>MY CART</p>
    </div>
</div>  
</div>
)
