...
<div className='category'>
    <div className='category_collections'>
        <h3>Collections</h3>
        <div>
            <p onClick={()=>this.props.onCollectionRouteChange('Dress')}>Dress</p>
            <p onClick={()=>this.props.onCollectionRouteChange('Phones')}>Mobiles</p>
            <p onClick={()=>this.props.onCollectionRouteChange('Laptops')}>Laptops</p>
            <p onClick={()=>this.props.onCollectionRouteChange('HeadPhones')}>HeadPhones</p>
            <p onClick={()=>this.props.onCollectionRouteChange('Cameras')}>Camera</p>
            <p onClick={()=>this.props.onCollectionRouteChange('Watches')}>Watches</p>
        </div>
    </div>
