...
<div className='footer'>
    ...
    <div className='footer_2'>
        ...
        <h3>Collection</h3>
            <ul>
            <li onClick={()=>this.props.onCollectionRouteChange('Dress')}>Dress</li>
            <li onClick={()=>this.props.onCollectionRouteChange('Phones')}>Mobiles</li>
            <li onClick={()=>this.props.onCollectionRouteChange('Laptops')}>Laptops</li>
            <li onClick={()=>this.props.onCollectionRouteChange('HeadPhones')}>HeadPhones</li>
            <li onClick={()=>this.props.onCollectionRouteChange('Cameras')}>Camera</li>
            <li onClick={()=>this.props.onCollectionRouteChange('Watches')}>Watches</li>
            </ul>
        </div>
